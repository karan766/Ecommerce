...
const SuccessIcon =
  <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="www.w3.org/2000/svg">
...
const InfoIcon =
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="www.w3.org/2000/svg">
...
export default function CompletePage() {
  ...
  return (
    <div id="payment-status" className="flex w-screen h-screen items-center justify-center">
      ...
      {intentId && <a href={`https://dashboard.stripe.com/payments/${intentId}`} id="view-details" rel="noopener noreferrer" target="_blank">View details
        <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="www.w3.org/2000/svg" style={{paddingLeft: '5px'}}>
