            ...
            <div key={product.id} className="">
              ...
              <div className="w-full border-solid border-2 p-2 border-gray-200 rounded-b-lg border-t-0 cursor-pointer">
                <Link
                  ...
                  className="rounded-md w-full bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 block text-center"
                >
